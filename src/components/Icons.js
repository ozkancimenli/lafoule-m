...
export const TwitterIcon = ({ className, ...rest }) => {
  // Render the X (formerly Twitter) logo while keeping the same export name
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={42}
    ...
    >
      <path
        fill='currentColor'
        d='M3 3h3.3l5.2 6.9L17.7 3H21l-7.4 9.8L21.6 21H18.3l-5.6-7.4L6.1 21H2.8l7.9-10.3L3 3Z'
      />
    </svg>
  );
};
