      ...
      <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-md">
        {filteredSubscribers.length === 0 ? (
          <div className="text-center py-12 text-gray-500 dark:text-gray-400">
            {searchTerm ? 'No subscribers found matching search criteria' : 'No subscribers yet'}
          </div>
        ) : (
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      <p><strong>Name:</strong> {subscriber.name || 'Not specified'}</p>
                      <p><strong>Registration Date:</strong> {new Date(subscriber.created_at).toLocaleString('en-US')}</p>
                      <p><strong>Source:</strong> {subscriber.source || 'website'}</p>
                    </div>
                  </div>
