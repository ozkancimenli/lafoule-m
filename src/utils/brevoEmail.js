...
export const sendContactNotificationEmail = async (contactData) => {
  ...
  return await sendEmail('cimenliozkan1@gmail.com', template.subject, template.htmlContent);
};
...
export const sendContactAutoReplyEmail = async (contactData) => {
  ...
  return await sendEmail(contactData.email, template.subject, template.htmlContent);
};
