      ...
      <section className='w-full mt-16 sm:mt-24 md:mt-32 px-5 sm:px-10 md:px-24 sxl:px-32 flex flex-col items-center justify-center'>
        ...
        <div className='w-full flex flex-col items-center text-center text-dark dark:text-light'>
          ...
          <p className='mt-4 max-w-2xl text-base sm:text-lg text-gray dark:text-light/70'>
            A curated showcase of production-ready applications that demonstrate
            my approach to modern full-stack development — scalable backends,
            reactive frontends, and real-time collaboration features.
          </p>
        </div>
